...
class AppLocalizationsRu extends AppLocalizations {
  ...
  @override
  String get editEvent => 'Редактировать ивент';

  @override
  String get eventTitle => 'Название ивента *';

  @override
  String get description => 'Описание';

  @override
  String get location => 'Место проведения *';

  @override
  String get maxParticipants => 'Макс. участников (0 = без ограничений)';
  ...
  @override
  String get selectCategoryPrompt => 'Выберите категорию';

  @override
  String get addPosterPrompt => 'Нажмите, чтобы добавить постер';
  ...
  @override
  String get onlyClubsCreate => 'Только клубы могут создавать ивенты';

  @override
  String get imageError => 'Ошибка выбора изображения';

  @override
  String get selectDateTimePrompt => 'Выберите дату и время ивента';

  @override
  String get eventUpdated => 'Ивент обновлён!';

  @override
  String get eventCreated => 'Ивент создан!';
  ...
  @override
  String get unibuddyInputHint => 'Спроси про ивенты или кампус…';

  @override
  String get unibuddyEmptyHint => 'Например: где сегодня ивенты, или про каратэ — ответы из синхронизированных данных кампуса.';

  @override
  String get recommendationForYou => 'Для тебя';

  @override
  String get interestsLabel => 'Интересы (через запятую)';

  @override
  String get interestsHint => 'например: танцы, IT, карате';

  @override
  String get interestsSaved => 'Интересы сохранены';

  @override
  String get fillInterestsHint => 'Добавь интересы в Настройках — появятся персональные подборки.';

  @override
  String get recoCouldNotLoad => 'Не удалось загрузить рекомендации';
  ...
  @override
  String get emptyFields => 'Заполните все поля';

  @override
  String get invalidEmail => 'Некорректный email';

  @override
  String get shortPassword => 'Пароль слишком короткий (мин. 8 символов)';

  @override
  String get authErrorWrong => 'Неверный email или пароль';

  @override
  String get authErrorNotFound => 'Пользователь не найден';

  @override
  String get authErrorTooMany => 'Слишком много попыток. Попробуйте позже.';
  ...
  @override
  String get resetPasswordPrompt => 'Введите email — мы отправим ссылку для сброса.';

  @override
  String get sendEmail => 'Отправить';

  @override
  String get enterClubName => 'Введите название клуба';

  @override
  String get enterNameSurname => 'Введите имя и фамилию';
  ...
  @override
  String get registerAsClub => 'Регистрация клуба';

  @override
  String get registerAsStudent => 'Регистрация студента';

  @override
  String get haveAccount => 'Уже есть аккаунт?';

  @override
  String get memberCount => 'участников';

  @override
  String get aboutClub => 'О клубе';

  @override
  String get following => 'Подписка';

  @override
  String get follow => 'Подписаться';

  @override
  String get eventNotFound => 'Ивент не найден';
  ...
  @override
  String get deleteConfirmTitle => 'Удалить ивент?';

  @override
  String get deleteConfirmContent => 'Это действие нельзя отменить.';

  @override
  String get organizer => 'Организатор';

  @override
  String get participantsCount => 'мест';

  @override
  String get unlimitedParticipants => 'участников (без лимита)';
  ...
  @override
  String get cancelParticipation => 'Отменить участие';

  @override
  String get participate => 'Участвовать';
